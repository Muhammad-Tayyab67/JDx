                            ...
                            <table id="example3" class="display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $serial + 1 }}</td>
                                        <td>{{ $role->name }}</td>
                                        <td><a href="#" class="btn btn-primary shadow btn-xs sharp" data-toggle="modal" data-target="#actionModal1{{$serial}}"><i class="fa fa-eye"></i></a>
                                        </td>
                                          <div class="modal fade" id="actionModal1{{$serial}}" tabindex="-1" role="dialog">
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex">
                                                @can('Edit Role')
                                                <a href="{{ url('roles/edit/'.encrypt($role->id)) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                @endcan
                                                @can('Delete Role')

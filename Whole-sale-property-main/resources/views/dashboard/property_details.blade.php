							...
							<div class="col-xl-12 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-header mb-0 border-0">
										<h3 class="fs-20 mb-0 text-white">Property Location</h3>
									</div>
							...
							<div class="col-xl-12 col-lg-6 col-md-12">
								<div class="card">
									<div class="card-header mb-0 border-0 pb-0">
										<h3 class="fs-20 text-white mb-0">Owner History</h3>
									</div>
							...
							<div class="col-xl-12">
								<div class="card property-features">
									<div class="card-header border-0 pb-0">	
										<h3 class="fs-20 text-white mb-0">Property Features</h3>
									</div>
									<div class="card-body">
										<ul>

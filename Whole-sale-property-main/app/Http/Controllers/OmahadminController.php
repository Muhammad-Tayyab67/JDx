...
class OmahadminController extends Controller
{
    ...
    public function dashboard_1()
    {
        ...
        $action = __FUNCTION__;
        // Mapper::map(33.6415025, 73.0499592);
        // $location = Mapper::location('Islamabad , I-10/1');
        // Mapper::marker($location->getLatitude(), $location->getlongitude(), ['animation' => 'DROP', 'label' => 'Marker', 'title' => 'Marker', 'draggable' => true]);
         
        return view('dashboard.index', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function analytics()
    {
        ...
        return view('dashboard.analytics', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function customer_list()
    {
        ...
        return view('dashboard.customer_list', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function property_details()
    {
        ...
        return view('dashboard.property_details', compact('page_title', 'page_description','action','logo'));
    }
            // Order List
    public function order_list()
    {
        ...
        return view('dashboard.order_list', compact('page_title', 'page_description','action','logo'));
    }
            // Review
    public function review()
    {
        ...
        return view('dashboard.review', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function user()
    {
        ...
        return view('UserManagement.user.view', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function User_Form()
    {
        ...
        $action = __FUNCTION__;
        $roles = Role::all();    
        return view('UserManagement.user.form', compact('roles','page_title', 'page_description','action','logo'));
    }
    ...
    public function User_Edit()
    {
        ...
        return view('UserManagement.user.edit', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function Roles_Edit()
    {
        ...
        return view('UserManagement.roles.edit', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function Employee_LIST()
    {
        ...
        return view('HumanResourceManagement.view', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function Employee_FORM()
    {
        ...
        return view('HumanResourceManagement.form', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function Employee_EDIT()
    {
        ...
        return view('HumanResourceManagement.edit', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function Scout_LIST()
    {
        ...
        return view('PropertyManagement.scout.view', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function Scout_FORM()
    {
        ...
        return view('PropertyManagement.scout.form', compact('page_title', 'page_description','action','logo'));
    }
                
    // Scout_Edit
    public function Scout_EDIT()
    {
        $page_title = 'Property Management';
        $page_description = 'Some description for the page';
        $logo = "images/KECO-logo.png";
        ...
        return view('PropertyManagement.scout.edit', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function Property_LIST()
    {
        ...
        return view('PropertyManagement.property.view', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function Property_FORM()
    {
        ...
        return view('PropertyManagement.property.form', compact('page_title', 'page_description','action','logo'));
    }
    ...
    public function Property_EDIT()
    {
        ...
        return view('PropertyManagement.property.edit', compact('page_title', 'page_description','action','logo'));
    }
        ...
        public function Property_Files()
        {
            ...
            return view('PropertyManagement.property.files', compact('page_title', 'page_description','action','logo'));
        }

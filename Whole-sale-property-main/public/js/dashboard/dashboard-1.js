(function($) {
 ...
 var dzChartlist = function(){
	...
	var Revenue = [];
	var month_r = [];
	for(var i = 0; i < revenue_generated_retreieve_array.length; i++)
	{
		Revenue[i] = revenue_generated_retreieve_array[i].revenue;
		month_r[i] = revenue_generated_retreieve_array[i].Month;

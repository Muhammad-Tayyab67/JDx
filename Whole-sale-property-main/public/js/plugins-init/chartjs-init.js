 ...
 var dzSparkLine = function(){
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(255, 99, 71, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(255, 99, 71, 0.5)");
	...
	var leads = [];
	var month = [];
	for(var i = 0; i < leads_generated.length; i++)
	{
		leads[i] = leads_generated[i].leads;
		month[i] = leads_generated[i].Month;

	}

	var LeadsGraph = function(){
		if(jQuery('#LeadsGraph').length > 0 ){

		//gradient bar chart
			const LeadsGraph = document.getElementById("LeadsGraph").getContext('2d');
			//generate gradient
			const LeadsGraphgradientStroke = LeadsGraph.createLinearGradient(0, 0, 0, 250);
			LeadsGraphgradientStroke.addColorStop(0, "rgba(255, 99, 71, 1)");
			LeadsGraphgradientStroke.addColorStop(1, "rgba(255, 99, 71, 0.5)");

			LeadsGraph.height = 100;
					...
					datasets: [
						{
							label: "Leads ",
							data: leads,
							borderColor: LeadsGraphgradientStroke,
							borderWidth: "0",
							backgroundColor: LeadsGraphgradientStroke, 
							hoverBackgroundColor: LeadsGraphgradientStroke
						}
					]
				},
				options: {
	...
	var leads_c = [];
	var month_c = [];
	for(var i = 0; i < contracts_generated_retreieve_array.length; i++)
	{
		leads_c[i] = contracts_generated_retreieve_array[i].contracts;
		month_c[i] = contracts_generated_retreieve_array[i].Month;

	}

	var ContractsGraph = function(){
		if(jQuery('#ContractsGraph').length > 0 ){

		//gradient bar chart
			const ContractsGraph = document.getElementById("ContractsGraph").getContext('2d');
			//generate gradient
			const ContractsGraphgradientStroke = ContractsGraph.createLinearGradient(0, 0, 0, 250);
			ContractsGraphgradientStroke.addColorStop(0, "rgba(96,246,0,1)");
			ContractsGraphgradientStroke.addColorStop(1, "rgba(96,246,0,0.5)");

			ContractsGraph.height = 100;

			new Chart(ContractsGraph, {
				type: 'bar',
				data: {
					defaultFontFamily: 'Poppins',
					labels: month_c,
					datasets: [
						{
							label: "Contracts ",
							data: leads_c,
							borderColor: ContractsGraphgradientStroke,
							borderWidth: "0",
							backgroundColor: ContractsGraphgradientStroke, 
							hoverBackgroundColor: ContractsGraphgradientStroke
						}
					]
				},
				options: {
	...
	for(var i = 0; i < contracts_generated_retreieve_array.length; i++)
	{
		leads_a[i] = appointments_generated_retreieve_array[i].appointments;
		month_a[i] = appointments_generated_retreieve_array[i].Month;

	}

	var AppointmentsGraph = function(){
		if(jQuery('#AppointmentsGraph').length > 0 ){

		//gradient bar chart
			const AppointmentsGraph = document.getElementById("AppointmentsGraph").getContext('2d');
			//generate gradient
			const AppointmentsGraphgradientStroke = AppointmentsGraph.createLinearGradient(0, 0, 0, 250);
			AppointmentsGraphgradientStroke.addColorStop(0, "rgba(9, 76, 184, 1)");
			AppointmentsGraphgradientStroke.addColorStop(1, "rgba(9, 76, 184, 0.5)");

			AppointmentsGraph.height = 100;

			new Chart(AppointmentsGraph, {
				type: 'bar',
				data: {
					defaultFontFamily: 'Poppins',
					labels: month_a,
					datasets: [
						{
							label: "Appointments ",
							data: leads_a,
							borderColor: AppointmentsGraphgradientStroke,
							borderWidth: "0",
							backgroundColor: AppointmentsGraphgradientStroke, 
							hoverBackgroundColor: AppointmentsGraphgradientStroke
						}
					]
				},
				options: {
	...
	var barChart2_0 = function(){
		if(jQuery('#barChart_2_0').length > 0 ){

		//gradient bar chart
			const barChart_2_0 = document.getElementById("barChart_2_0").getContext('2d');
			//generate gradient
			const barChart_2_0gradientStroke = barChart_2_0.createLinearGradient(0, 0, 0, 250);
			barChart_2_0gradientStroke.addColorStop(0, "rgba(9, 76, 184, 1)");
			barChart_2_0gradientStroke.addColorStop(1, "rgba(59, 76, 184, 0.5)");

			barChart_2_0.height = 100;

			new Chart(barChart_2_0, {
				type: 'bar',
				data: {
					defaultFontFamily: 'Poppins',
					labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
					datasets: [
						{
							label: "My First dataset",
							data: [65, 59, 80, 81, 56, 55, 40],
							borderColor: barChart_2_0gradientStroke,
							borderWidth: "0",
							backgroundColor: barChart_2_0gradientStroke, 
							hoverBackgroundColor: barChart_2_0gradientStroke
						}
					]
				},
				options: {
